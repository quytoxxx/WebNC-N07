...
class PaymentController extends Controller
{
    ...
    public function create_pay(Request $request){
        ...
        //         'name' => $name,
        //         'price' => $item['price'],
        //         'desc'  => 'Thank you for using vnpay',
        //         'qty' => $item['quantity']
        //     ];
        // }, $cart);
        ...
        $vnp_TmnCode = "5GE3P9EL"; //Mã website tại VNPAY
        $vnp_HashSecret = "PTLDDBCUHAZTKDOIGNFYWTSWENLFBSYA"; //Chuỗi bí mật
        $vnp_Url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
        $vnp_Returnurl = "http://dollyharris.test:8080/checkout";
