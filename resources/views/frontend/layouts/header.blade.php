                        ...
                        <ul class="list-main">
                            ...
                            @auth
                                @if (Auth::user()->role == 'admin')
                                    <li><i class="ti-user"></i> <a href="{{ route('admin') }}" target="_blank">Quản lý tài
                                            khoản</a></li>
                                @else
                                    <li><i class="ti-user"></i> <a href="{{ route('user') }}" target="_blank">Quản lý tài
                                            khoản</a></li>
                                @endif
                                ...
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            ...
                                            <span class="total-amount">{{ number_format(Helper::totalWishlistPrice(), 0) }}
                                                đ</span>
                                        </div>
                            ...
                            @auth
                                <div class="shopping-item">
                                    ...
                                    <div class="bottom">
                                        <div class="total">
                                            <span>Tổng số tiền</span>
                                            <span class="total-amount">{{ number_format(Helper::totalCartPrice(), 0) }}
                                                đ</span>
                                        </div>
